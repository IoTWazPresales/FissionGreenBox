  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img style={{ padding: 5, height: 70 }} src="/app/logo_GreenDoor_Expo.png" alt="GreenDoor" />
          <img style={{ padding: 5, height: 70 }} src="/app/logo_Indorsun_White.png" alt="Indorsun" />
          <img style={{ padding: 5, height: 70 }} src="/app/logo_TheGrowBar.png" alt="GrowBar" />
          <img style={{ padding: 5, height: 70 }} src="/app/logo_iotnxt.png" alt="GreenDoor" />
        </div>
